...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2020 at 10:58 PM
...
--
CREATE DATABASE IF NOT EXISTS `companydirectory` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
INSERT INTO `personnel` (`id`, `firstName`, `lastName`, `jobTitle`, `email`, `departmentID`, `title`, `dob`, `address_1`, `address_2`, `post_code`, `city`, `phone`, `hod`, `salary`, `start_date`, `end_date`, `work_history`) VALUES
...
(23, 'Tamarra', 'Ace', '', 'tacem@vinaora.com', 9, '', '0000-00-00', '', '', '', '', '', '', '', '0000-00-00', '', ''),
...
(128, 'Tamarra', 'Ace', '', '', 1, 'mr', '0000-00-00', '', '', '', '', '', '', '', '0000-00-00', '', '');
